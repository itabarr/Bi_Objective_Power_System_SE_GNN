"""
DeepGAT Training Script - Using Original Methods

This script uses the original training approach from dsml_dss2_run.py
but organized in notebook-style sections for better readability.
"""
